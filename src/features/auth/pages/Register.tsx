...
import {
  RegisterFormData,
  RegisterSchema,
} from "@/features/auth/validations/RegisterValidation";
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full bg-primary text-white py-2 rounded-md hover:opacity-90 transition duration-200 flex justify-center items-center"
          >
        ...
        <a
          href={env.VITE_GOOGLE_OAUTH_URL}
